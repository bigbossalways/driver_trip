        <form action="" method="post">
            ...
            <div class="form-floating mb-3">
                <input class="form-control" id="inputinitkm" name="inputinitkm" type="number" placeholder="Init Km" />
                <label for="inputinitkm">Init Km</label>
            </div>
            <div class="form-floating mb-3">
                <input class="form-control" id="inputendkm" name="inputendkm" type="number" placeholder="End Km" />
                <label for="inputendkm">End Km</label>
            </div>
